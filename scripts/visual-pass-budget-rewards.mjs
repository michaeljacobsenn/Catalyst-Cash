...
const SEEDED_AUDIT = {
  ...
  parsed: {
    ...
    healthScore: {
      ...
      grade: "A+",
      trend: "up",
      summary: "Cash is protected, bills are covered, and the week has real room.",
      narrative: "This seeded audit keeps the shell in a strong, realistic state for responsive UI checks.",
    },
    dashboardCard: [
      { category: "Checking", amount: "$6,900.00", status: "Protected" },
      { category: "Vault", amount: "$14,500.00", status: "Over target" },
      { category: "Pending", amount: "$225.00", status: "Upcoming" },
      { category: "Debts", amount: "$0.00", status: "Clear" },
      { category: "Available", amount: "$3,059.51", status: "SURPLUS" },
    ],
    weeklyMoves: ["Hold checking above $1,500.", "Route true surplus toward Roth and brokerage contributions."],
    nextAction: "Keep the protected checking floor intact, then automate the next surplus transfer.",
    categories: {
      Rent: { total: 1050 },
      Utilities: { total: 165 },
      Groceries: { total: 298 },
...
const SEEDED_STORAGE = {
  ...
  "backup-nudge-dismissed": SEEDED_NOW,
  "last-backup-ts": SEEDED_NOW,
  "last-portable-backup-ts": SEEDED_NOW,
  "last-portable-backup-kind": "icloud",
