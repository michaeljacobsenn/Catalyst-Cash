...
describe("evaluateBadges", () => {
    ...
    it("unlocks debt_halved when total debt drops 50%+", async () => {
        ...
        const mid1 = makeAudit({ date: "2024-03-01", form: { checking: 3000, ally: 500, debts: [{ balance: 7000, minPayment: 200, apr: 19.99 }] } });
        const mid2 = makeAudit({ date: "2024-04-01", form: { checking: 3000, ally: 500, debts: [{ balance: 5500, minPayment: 200, apr: 19.99 }] } });
