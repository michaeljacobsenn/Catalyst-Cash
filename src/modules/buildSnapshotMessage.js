...
export function buildSnapshotMessage({
    ...
    parsedTransactions, budgetActuals, holdingValues,
    ...
    const blocks = {
        ...
        transactions: (() => {
            ...
            const txnLines = parsedTransactions.map(t => `  ${t.date} | $${t.amount.toFixed(2)} | ${t.description}${t.category ? ` [${t.category}]` : ""}`).join("\n");
