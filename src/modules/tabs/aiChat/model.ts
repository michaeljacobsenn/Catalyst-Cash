...
export function getChatViewportDensity({
  ...
  return {
    ...
    denseEmbedded,
    ultraDenseEmbedded,
    suggestionCardMinHeight: ultraDenseEmbedded ? 68 : denseEmbedded ? 74 : compactEmbedded ? 82 : 88,
    suggestionGridGap: ultraDenseEmbedded ? 5 : denseEmbedded ? 6 : 8,
    suggestionColumns: viewport.width <= 390 ? 1 : 2,
    emptyTopPadding: ultraDenseEmbedded ? 0 : denseEmbedded ? 8 : compactEmbedded ? 18 : 28,
    orbSize: ultraDenseEmbedded ? 40 : denseEmbedded ? 44 : compactEmbedded ? 50 : 56,
    orbIconSize: ultraDenseEmbedded ? 17 : denseEmbedded ? 19 : compactEmbedded ? 21 : 24,
    titleSize: ultraDenseEmbedded ? 18 : denseEmbedded ? 19 : compactEmbedded ? 21 : 22,
    emptyCopySize: ultraDenseEmbedded ? 11 : 12,
    chipMarginBottom: ultraDenseEmbedded ? 4 : denseEmbedded ? 6 : compactEmbedded ? 8 : 10,
    promptClamp: 0,
  };
}
