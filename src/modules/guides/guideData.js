...
export const PAYWALL_FEATURES = [
  ...
  { label: "AI Models", free: "OpenAI Catalyst AI", pro: "CFO + Boardroom", icon: "🧠" },
  ...
  { label: "Transaction Ledger", free: "5-transaction preview", pro: "Full search + export", icon: "📒" },
  { label: "Rewards Ranking", free: "Best card pick", pro: "Full ranking stack", icon: "💳" },
  { label: "Renewals AI Assist", free: "Manual tracking", pro: "Detection + scripts", icon: "🔁" },
