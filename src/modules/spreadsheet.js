...
export async function generateBackupSpreadsheet(passphrase = null) {
    ...
    const sheet = workbook.addWorksheet('Setup Data', {
        views: [{ state: 'frozen', ySplit: 1 }]
    });

    sheet.columns = [
        { header: 'field_key', key: 'key', width: 25 },
    ...
    const rows = [
        ...
        { key: 'taxBracketPercent', desc: 'Tax Bracket (%)', val: financialConfig.taxBracketPercent || '' },
        ...
        { key: 'k401EmployerMatchPct', desc: 'Employer Match %', val: financialConfig.k401EmployerMatchPct || 100 },
        { key: 'k401EmployerMatchLimit', desc: 'Match Ceiling % of salary', val: financialConfig.k401EmployerMatchLimit || 5 },
    ];
