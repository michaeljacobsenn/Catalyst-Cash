        ...
        if (this.state.hasError) {
            ...
            return (
                <div role="alert" style={{
                    padding: "16px", borderRadius: T.radius.md,
                    background: T.status.redDim, border: `1px solid ${T.status.red}25`,
                    display: "flex", alignItems: "center", gap: 10, margin: "4px 0"
                }}>
                    <AlertTriangle size={16} color={T.status.red} />
                    <div>
                        <div style={{ fontSize: 12, fontWeight: 700, color: T.status.red }}>
                    ...
                    <button
                        ...
                        style={{
                            marginLeft: "auto", padding: "6px 12px", borderRadius: T.radius.sm,
                            border: `1px solid ${T.status.red}40`, background: "transparent",
                            color: T.status.red, fontSize: 10, fontWeight: 700, cursor: "pointer"
                        }}
                    >
                        Retry
                    </button>
