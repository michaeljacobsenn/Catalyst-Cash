    ...
    <Card variant="glass" style={{
      ...
      <div style={{ display: "flex", flexDirection: "column", gap: 4 }}>
        <div style={{ display: "flex", alignItems: "center", gap: 6 }}>
          {isDanger ? <AlertTriangle size={14} color={mainColor} /> : <ShieldCheck size={14} color={mainColor} />}
          <span style={{ fontSize: 13, fontWeight: 700, color: T.text.primary }}>
            Safe to Spend
          </span>
        </div>
        <span style={{ fontSize: 11, color: T.text.dim, lineHeight: 1.3 }}>
          {deductionText}
        </span>
      </div>

      <div style={{ display: "flex", flexDirection: "column", alignItems: "flex-end" }}>
        <span style={{ fontSize: 24, fontWeight: 800, color: mainColor, letterSpacing: "-0.02em" }}>
