...
export default function SinkingFundsRing({ paceData }) {
    ...
    return (
        <Card animate delay={150} style={{ background: T.bg.card, border: `1px solid ${T.border.subtle}` }}>
            <div style={{ display: "flex", alignItems: "center", gap: 8, marginBottom: 14 }}>
                ...
                <span style={{ fontSize: 13, fontWeight: 800, letterSpacing: "-0.01em" }}><InlineTooltip term="Sinking fund">Sinking Funds</InlineTooltip></span></div>
